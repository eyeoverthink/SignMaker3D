...
# ==========================================
#   SIGN SCULPTOR STUDIO: RELIEF ENGINE (FIXED)
# ==========================================
...
class SignSculptorApp:
    def __init__(self, root):
        ...
        # FIX: Save to Desktop so you can find it easily
    ...
    def setup_ui(self):
        ...
        # 5. Open Folder Button (NEW)
        btn_open_folder = tk.Button(controls_frame, text="📂 Open Output Folder", command=self.open_output_folder, bg="#7f8c8d", fg="white", font=("Arial", 9))
        btn_open_folder.pack(side=tk.BOTTOM, fill=tk.X, pady=5)
    ...
    def generate_files(self):
        ...
        msg_box = tk.Message(self.root, width=400)
        result = messagebox.askyesno("Success", f"Files Generated on Desktop!\nFolder: SignSculptor_Exports\n\nWould you like to open the folder now?")
        if result:
